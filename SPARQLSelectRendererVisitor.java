...
public class SPARQLSelectRendererVisitor extends GraphPatternRendererVisitor implements AlignmentVisitor{
    ...
    public void ifEmbeddedBlankWeakness(Properties p){
	...
	public void ifSplitdirIndentNl(Properties p){
    ...
    public void forEPrefix(String query) {
	...
	public void ifSplit(String query){
		if ( split ) {
