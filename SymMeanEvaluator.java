...
public class SymMeanEvaluator extends BasicEvaluator implements Evaluator {
    ...
    public void forCicleAlign2(LoadedOntology onto1, int nbClassCell, int nbPropCell, int nbIndCell) throws OntowrapException {
        for (Cell c2 : align2) {
    ...
    public double eval(Properties params, Object cache) throws AlignmentException {
        ...
        try {
            ...
            this.forCicle(onto1,nbClassCell,nbIndCell,nbPropCell,onto2);

            this.forCicleAlign2(onto1,nbClassCell,nbPropCell,nbIndCell);
