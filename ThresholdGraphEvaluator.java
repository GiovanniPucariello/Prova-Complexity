...
public class ThresholdGraphEvaluator extends GraphEvaluator {
    ...
    public void forCicleCellSet(double fmeasure, int nbfound,int nbcorrect, double prevt, double next, double increment){
	...
	*/
	...
	this.forCicleCellSet(fmeasure,nbfound,nbcorrect,prevt,next,increment);
